...
public class MessageModalSelectors {
        ...
        public static By successMessage(String successMessage) {
                return By.xpath("//body/div[@id='__next']/div[contains(@class,'ResponseMessages_container__wVOwE')]/div[contains(@class,'ResponseMessages_message__gcPjy')]/p[1][contains(text(), '"
                                + successMessage + "')]");
        }
